...
set arrow  1 from  -25,   0 to 65, 0 nofilled size 3,5,5 lc rgb "#000000" lw 2
set arrow  2 from    0, -25 to  0,65 nofilled size 3,5,5 lc rgb "#000000" lw 2
...
set arrow  6 from A[1], A[2] to A[1],P[2] nofilled size 8,0,0 lc rgb "#AAAAAA" lw 1
set arrow  7 from A[1], A[2] to    0,A[2] nofilled size 8,0,0 lc rgb "#AAAAAA" lw 1
set arrow  8 from B[1], B[2] to B[1],0    nofilled size 8,0,0 lc rgb "#AAAAAA" lw 1
set arrow  9 from B[1], B[2] to P[1],B[2] nofilled size 8,0,0 lc rgb "#AAAAAA" lw 1
set arrow 10 from P[1], A[2] to P[1],B[2] nofilled size 8,0,0 lc rgb "#AAAAAA" lw 1
set arrow 11 from B[1], P[2] to A[1],P[2] nofilled size 8,0,0 lc rgb "#AAAAAA" lw 1
