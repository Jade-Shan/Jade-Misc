...
set label 5 at  30,  5 point pt 7 ps 1.5 lc rgb "#AAAAAA"
set label 6 at   5, 30 point pt 7 ps 1.5 lc rgb "#AAAAAA"
...
set arrow 8 from   30, 30 to 30, 5 nofilled size 8,0,0 lc rgb "#AAAAAA" lw 1
set arrow 9 from   30, 30 to  5,30 nofilled size 8,0,0 lc rgb "#AAAAAA" lw 1
