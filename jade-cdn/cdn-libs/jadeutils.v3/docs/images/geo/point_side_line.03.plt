...
set arrow  8 from A[1], A[2] to C[1],C[2] nofilled size 8,0,0 lc rgb "#AAAAAA" lw 1
...
set arrow 10 from C[1], C[2] to C[1],A[2] nofilled size 8,0,0 lc rgb "#AAAAAA" lw 1
set arrow 11 from B[1], B[2] to A[1],B[2] nofilled size 8,0,0 lc rgb "#AAAAAA" lw 1
set arrow 12 from P[1], P[2] to A[1],C[2] nofilled size 8,0,0 lc rgb "#AAAAAA" lw 1
...
set label 4 at C[1],C[2] point pt 7 ps 1.5 lc rgb "#AAAAAA"
set label 5 at B[1],A[2] point pt 7 ps 1.5 lc rgb "#AAAAAA"
set label 6 at C[1],A[2] point pt 7 ps 1.5 lc rgb "#AAAAAA"
set label 7 at A[1],B[2] point pt 7 ps 1.5 lc rgb "#AAAAAA"
set label 8 at A[1],C[2] point pt 7 ps 1.5 lc rgb "#AAAAAA"

set label  9 "P"    at P[1]+3,P[2]+2
set label 11 "A"    at A[1]-3,A[2]+3
set label 12 "B"    at B[1]-3,B[2]+3
set label 17 "C"    at C[1]  ,C[2]+3
set label 13 "B.dx" at B[1]-3,A[2]-2
set label 14 "C.dx" at C[1]  ,A[2]-2
set label 15 "B.dy" at A[1]-8,B[2]   
set label 16 "C.dy" at A[1]-8,C[2]   
