...
DodgerBlue           : {color: ColorRGB.fromStrHex('#1E90FF'), rev: ColorRGB.fromStrHex('#800000')},
LightSeaGreen        : {color: ColorRGB.fromStrHex('#20B2AA'), rev: ColorRGB.fromStrHex('#800000')},
...
MediumSeaGreen       : {color: ColorRGB.fromStrHex('#3CB371'), rev: ColorRGB.fromStrHex('#800000')},
...
CadetBlue            : {color: ColorRGB.fromStrHex('#5F9EA0'), rev: ColorRGB.fromStrHex('#A52A2A')},
...
SlateGray            : {color: ColorRGB.fromStrHex('#708090'), rev: ColorRGB.fromStrHex('#9400D3')},
LightSlateGray       : {color: ColorRGB.fromStrHex('#778899'), rev: ColorRGB.fromStrHex('#9400D3')},
...
Olive                : {color: ColorRGB.fromStrHex('#808000'), rev: ColorRGB.fromStrHex('#006400')},
...
IndianRed            : {color: ColorRGB.fromStrHex('#CD5C5C'), rev: ColorRGB.fromStrHex('#000080')},
Peru                 : {color: ColorRGB.fromStrHex('#CD853F'), rev: ColorRGB.fromStrHex('#327AC0')},
Chocolate            : {color: ColorRGB.fromStrHex('#D2691E'), rev: ColorRGB.fromStrHex('#0000CD')},
...
Orchid               : {color: ColorRGB.fromStrHex('#DA70D6'), rev: ColorRGB.fromStrHex('#2F4F4F')},
GoldenRod            : {color: ColorRGB.fromStrHex('#DAA520'), rev: ColorRGB.fromStrHex('#255ADF')},
PaleVioletRed        : {color: ColorRGB.fromStrHex('#DB7093'), rev: ColorRGB.fromStrHex('#2F4F4F')},
...
OrangeRed            : {color: ColorRGB.fromStrHex('#FF4500'), rev: ColorRGB.fromStrHex('#00008B')},
Tomato               : {color: ColorRGB.fromStrHex('#FF6347'), rev: ColorRGB.fromStrHex('#00008B')},
...
// 6b8e23
export let namedRGBColor:Array<{color: ColorRGB, rev: ColorRGB, name: string}> = [
...
{color: ColorRGB.fromStrHex('#1E90FF'), rev: ColorRGB.fromStrHex('#800000'), name: 'DodgerBlue'          },
{color: ColorRGB.fromStrHex('#20B2AA'), rev: ColorRGB.fromStrHex('#800000'), name: 'LightSeaGreen'       },
...
{color: ColorRGB.fromStrHex('#3CB371'), rev: ColorRGB.fromStrHex('#800000'), name: 'MediumSeaGreen'      },
...
{color: ColorRGB.fromStrHex('#5F9EA0'), rev: ColorRGB.fromStrHex('#A52A2A'), name: 'CadetBlue'           },
...
{color: ColorRGB.fromStrHex('#708090'), rev: ColorRGB.fromStrHex('#9400D3'), name: 'SlateGray'           },
{color: ColorRGB.fromStrHex('#778899'), rev: ColorRGB.fromStrHex('#9400D3'), name: 'LightSlateGray'      },
...
{color: ColorRGB.fromStrHex('#808000'), rev: ColorRGB.fromStrHex('#006400'), name: 'Olive'               },
...
{color: ColorRGB.fromStrHex('#CD5C5C'), rev: ColorRGB.fromStrHex('#000080'), name: 'IndianRed'           },
{color: ColorRGB.fromStrHex('#CD853F'), rev: ColorRGB.fromStrHex('#327AC0'), name: 'Peru'                },
{color: ColorRGB.fromStrHex('#D2691E'), rev: ColorRGB.fromStrHex('#0000CD'), name: 'Chocolate'           },
...
{color: ColorRGB.fromStrHex('#DA70D6'), rev: ColorRGB.fromStrHex('#2F4F4F'), name: 'Orchid'              },
{color: ColorRGB.fromStrHex('#DAA520'), rev: ColorRGB.fromStrHex('#255ADF'), name: 'GoldenRod'           },
{color: ColorRGB.fromStrHex('#DB7093'), rev: ColorRGB.fromStrHex('#2F4F4F'), name: 'PaleVioletRed'       },
...
{color: ColorRGB.fromStrHex('#FF4500'), rev: ColorRGB.fromStrHex('#00008B'), name: 'OrangeRed'           },
{color: ColorRGB.fromStrHex('#FF6347'), rev: ColorRGB.fromStrHex('#00008B'), name: 'Tomato'              },
